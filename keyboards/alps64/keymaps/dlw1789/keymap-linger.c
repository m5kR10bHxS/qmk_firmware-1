...
#define TH_B     LT(0, KC_B)     // B |
#define TH_F     LT(0, KC_Q)     // G Q
#define TH_Y     LT(0, KC_Y)     // Y ~
#define TH_X     LT(0, KC_Z)     // X Z
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WORKMAN] = LAYOUT_infinity( \
    ...
    * |        | J Z | G Q |  M  |  P  |  V  | ~ | | . : | / * | " ? | ' ! |     |     |        |
    * |-----------------------------------------------------------------------------------------+
    * |  Thorn  |  C  |gui S|alt N|ctl T|  K  | , ; |ctl A|alt E|gui I|  H  |     |             |
    * |-----------------------------------------------------------------------------------------+
  ...
  [_TITANIUM] = LAYOUT_infinity( \
    ...
    THORN,    KC_C,    S_GUI,   N_ALT,   T_CTL,   KC_K,    KC_COMM, A_CTL,   E_ALT,   I_GUI,   KC_H,    XXXXXXX, XXXXXXX,                   \
  ...
  [_CFG] = LAYOUT_infinity( \
    ...
    * |GESC |  1  |  2  |  3  |  4  |  5  |  6  |  7  |  8  |  9  |  0  |  -  |  =  |  \  |  ~  |
    * |-----------------------------------------------------------------------------------------+
    * |  Tab   |  Q  |  W  | Esc | Esc |Bksp |Bksp | Tab | Tab |  O  |  P  |  [  |  ]  | Bk Spc |
    * |-----------------------------------------------------------------------------------------+
