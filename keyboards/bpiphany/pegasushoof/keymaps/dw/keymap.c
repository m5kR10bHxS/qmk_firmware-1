...
/* Base Layer: _QWERTY
 * +-------+------+------+------+------+------+-----+------+------+------+------+----+------+------+-------+-------+    +--------+--------+--------+
 * |  Esc  |      |  F1  |  F2  |  F3  |  F4  |     |  F5  |  F6  |  F7  |  F8  |    |  F9  |  F10 |  F11  |  F12  |    | Prt Scr| Scr Lk |  Pause |
 * |-------+-------+-------+------+------+------+------+------+------+------+------+-------+-------+-------+-------|    |--------+--------+--------|
 ...
 * |-------+-------+-------+------+------+------+------+------+------+------+------+-------+-------+-------+-------|    +--------+--------+--------+
 * |  Ctrl |  GUI  |  Alt  |                     Space Fn (_NAV)                   |  Alt  | RAISE |  CCCV |  Ctrl |    |  Left  |  Down  |  Right |
 * +-------+-------+-------+-------------------------------------------------------+-------+-------+-------+-------+    +--------+--------+--------+
*/
 ...
 [_QWERTY] = LAYOUT_tkl_ansi( \
   ...
   KC_LCTL, KC_LGUI, KC_LALT,              LT(_NAV, KC_SPC),                KC_RALT, MO(_RAISE),       KC_CCCV, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT  \
 ),
 ...
 * |--------+------+------+------+------+------+------+------+------+------+------+-------+-------+-------+-------|    +--------+--------+--------+
 * |  Ctrl  |  GUI |  Alt |                     Space Fn (_NAV)                   |  Alt  | RAISE |  App  |  Ctrl |    |  Left  |  Down  |  Right |
 *  --------+------+------+-------------------------------------------------------+-------+-------+-------+-------     +--------+--------+--------+
*/
 ...
 [_WORKMAN] = LAYOUT_tkl_ansi( \
   ...
   KC_LCTL, KC_LGUI, KC_LALT,               LT(_NAV, KC_SPC),              KC_RALT, MO(_RAISE),       KC_APP,  KC_RCTL, KC_LEFT, KC_DOWN, RGHT     \
 ),
...
// Adjust Layer: _ADJ (_NAV + _FN)
 ...
 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
 _______, qwerty,  workman, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
// AS controls are for the Auto Shift function 
};
