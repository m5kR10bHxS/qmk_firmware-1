 ...
 */
 ...
 [_NAV] = LAYOUT_66_ansi(
  ...
  KC_CAPS, _______, _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, KS_INS,  _______,
 ...
 */
 ...
 [_FN] = LAYOUT_66_ansi(
  ...
  _______,    UC(0x263a), UC(0x2639), UC(0x2665), UC(0x2221), _______,    UC(0x2116), _______,    _______,    UC(0x03a9), UC(0x221e), _______, _______, 
  _______,    _______,    _______,    UC_0x2714), UC(0x2103), _______,    _______,    UC(0x03bb), _______,    _______,    _______,    _______,                    _______,
